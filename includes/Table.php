...
class Table
{
	...
	public static function get($inputData=array(),$callback='')
	{
		...
		// string: 'excludeFields'=>'summary',
		$excludeFields=isset($inputData['excludeFields'])?$inputData['excludeFields']:'';

		if(isset($excludeFields[1]))
		{
			$selectFields=str_replace($excludeFields, '', $selectFields);
